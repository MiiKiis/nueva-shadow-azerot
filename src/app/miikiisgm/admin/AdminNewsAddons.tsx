        ...
        <>
          ...
          <form onSubmit={handleAddAddon} className="mb-10 bg-black/40 border border-white/10 p-6 rounded-2xl grid grid-cols-1 md:grid-cols-2 gap-4 shadow-xl">
            ...
            <div className="md:col-span-2 flex flex-col gap-1">
              ...
              <textarea
                className="bg-black/60 border border-purple-500/30 rounded-xl px-4 py-3 text-white min-h-[92px] focus:outline-none focus:ring-2 focus:ring-pink-400/50 transition-all"
